...
const requests = {
    ...
    requestedAnimetion:`https://api.themoviedb.org/27/movie/horror?api_key=${key}`
  };

export default requests

export const details = (id) => {
  return `https://api.themoviedb.org/3/movie/${id}?api_key=15b489d482590738a2bd580bb842c207`
}